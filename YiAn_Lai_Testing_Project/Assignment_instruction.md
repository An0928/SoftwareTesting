...
- [v] Create Test cases for all pages which are already there in project's **PageObject** folder
  - [v] 03_RegisterPage
  - [v] 04_ProjectPage
  - [v] 05_IssuePage
- [v] Perform all **TODO:** tasks describe in each above pages
- [v] Create bug report for one test case which are already there in project's BugReport folder
  - [v] 02_ProjectPageReport
